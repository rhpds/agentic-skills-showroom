...
The keys live in `.claude/settings.json` (project) or `/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/settings.json` (global) — **not** in `.planning/config.json`:
