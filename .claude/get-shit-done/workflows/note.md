...
- **Global scope**: `/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/notes/`)
...
2. Glob `/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/notes/` — works in any directory
