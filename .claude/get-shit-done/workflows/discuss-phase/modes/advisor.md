...
> `/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/USER-PROFILE.md` exists). Skip the Read
...
```bash
PROFILE_CONTENT=$(cat "/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a `Agent()` in parallel:
   ...
   ```
   Agent(
     prompt="First, read @/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
