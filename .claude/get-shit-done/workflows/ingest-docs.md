...
```bash
INIT=$(node "/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
