...
INSTALL_JS_GLOBAL="/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
