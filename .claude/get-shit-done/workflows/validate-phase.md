...
```
Agent(
  prompt="Read /Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/templates/VALIDATION.md`
