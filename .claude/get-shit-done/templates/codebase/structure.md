...
- Usage: Reference from command with `@/Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/tok/Dropbox/PARAL/Projects/showroom-skills-course/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
